...
5. **Folder-scoped hub header (Library)** — When **`scope === "folder"`** in the URL, **`LibraryPageHeader`** **⋯ More** includes **Customize folder** — **`.agents/rules/exxat-library-hub-header.md`**.
