...
| Topic | Path |
|-------|------|
| Pattern | `docs/exxat-ds/whats-new-sheet-pattern.md` |
| Handoff | `docs/exxat-ds/handoff/whats-new-sheet-small.md` |
| Component map | `WhatsNewSheet` in `docs/exxat-ds/component-map.json` |
| Utility bar | `docs/exxat-ds/shell-utility-bar-pattern.md` |

## Rules (scoped)

- `.agents/rules/exxat-whats-new-sheet.md`
- `.agents/rules/exxat-utility-bar.md` (megaphone placement)
...
- `.agents/skills/exxat-overlays/SKILL.md`
- `lib/design-system/component-docs/whats-new-sheet.tsx`
