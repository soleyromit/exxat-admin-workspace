...
<!-- Synced from .agents/rules/exxat-form-fields.mdc - run npx exxat-ui sync-extras after Cursor rule edits -->
...
- Use placeholders as the only format instruction (`exxat-accessibility.md`).
...
- **`exxat-reuse-before-custom.md`** — search `component-map.json` first
