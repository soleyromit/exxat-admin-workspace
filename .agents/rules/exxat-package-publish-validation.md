...
**Tell consumers:** bumping the package alone does **not** rewrite app source. `exxat-ui upgrade` refreshes package-owned shell from the generated starter while preserving builder-owned tenant catalog, data modules, mock/API wiring, and custom pages — see **`exxat-consumer-package-upgrade.md`**.
