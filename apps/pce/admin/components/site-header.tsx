  ...
  return (
    ...
    >
      <div className="flex w-full min-w-0 items-center gap-1 ps-2 pe-1.5 lg:gap-2 lg:pe-2">
        {/*
          Always show collapse/expand — even on record-detail chrome where the
          primary nav is unmounted. Keeps breadcrumb alignment with hub pages;
          trigger is disabled while `focusShellSupersedesPrimarySidebar` is true.
        */}
        <Tooltip>
          <TooltipTrigger asChild>
            {focusShellSupersedesPrimarySidebar ? (
              <span className="inline-flex">
                <SidebarTrigger className="ms-px" disabled />
              </span>
            ) : (
          ...
          <TooltipContent side="bottom" className="flex flex-wrap items-center gap-1.5">
            {focusShellSupersedesPrimarySidebar ? (
              <span>Navigation hidden on this page</span>
            ) : (
              <>
