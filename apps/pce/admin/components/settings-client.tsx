  ...
  return (
    <section id="banner" className="scroll-mt-20">
      <header className="mb-8 space-y-1">
        <h2 className="text-lg font-semibold text-foreground font-heading">System banner &amp; alerts</h2>
  ...
  return (
    <section id="builder-onboarding" className="scroll-mt-20">
      <header className="mb-6 space-y-1">
        <h2 className="text-lg font-semibold text-foreground font-heading">Builder onboarding</h2>
        <p className="text-sm text-muted-foreground">
    ...
    <div className="flex w-full min-w-0 flex-col">
      ...
      <div className="mt-10 flex flex-col gap-20">
        <section id="account" className="scroll-mt-20">
          <header className="mb-6 space-y-1">
            <h2 className="text-lg font-semibold text-foreground font-heading">Account</h2>
            <p className="text-sm text-muted-foreground">
        ...
        <section id="input-formats" className="scroll-mt-20">
          <header className="mb-6 space-y-1">
            <h2 className="text-lg font-semibold text-foreground font-heading">Input formats</h2>
            <p className="text-sm text-muted-foreground">
        ...
        <section id="tours" className="scroll-mt-20">
          <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0 space-y-1">
              <h2 className="text-lg font-semibold text-foreground font-heading">Guided tours</h2>
              <p className="text-sm text-muted-foreground">
