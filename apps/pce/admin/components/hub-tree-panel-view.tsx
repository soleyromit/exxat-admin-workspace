    ...
    <Collapsible className="group/collapsible">
      ...
      >
        {hasChildren ? (
          <CollapsibleTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="icon-sm"
              className="icon-button-chrome size-8"
        ...
        <Button
          ...
          className={cn(
            "h-auto min-w-0 flex-1 items-center justify-start gap-2 py-1.5 pe-3 text-left text-sm font-normal duration-75",
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                  ...
                  <Tip label="Version history opens when connected to your CMS.">
                    <span className="inline-flex">
                      ...
                      >
                        Version history
                        <i className="fa-light fa-chevron-right text-xs leading-none opacity-70" aria-hidden="true" />
                      </Button>
                    </span>
                  </Tip>
                </div>
                        ...
                        >
                          ...
                          {isCorrect ? (
                            <span className="flex shrink-0 items-center gap-1 text-emerald-600 dark:text-emerald-400">
                              <i className="fa-light fa-circle-check text-xs leading-none" aria-hidden="true" />
