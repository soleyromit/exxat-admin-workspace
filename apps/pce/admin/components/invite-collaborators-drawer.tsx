    ...
    <Popover open={open} onOpenChange={setOpen} modal={false}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn("h-auto rounded-full font-normal", triggerClassName)}
        >
...
export function InviteCollaboratorsDrawer({
  ...
  return (
    <FloatingSheetPanel open={open} onOpenChange={handleOpenChange}>
      <FloatingSheetPanelContent contentSlot="invite-collaborators-drawer">
        <FloatingSheetPanelToolbar />
        <FloatingSheetPanelHeader
          title="Collaborators"
          description={`Manage who can access ${resourceLabel}.`}
        />
