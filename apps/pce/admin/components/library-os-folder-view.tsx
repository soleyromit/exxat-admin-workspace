 ...
 * create (floating sheet panel with a live preview), inline rename, move / delete,
 * and move questions between folders.
 */
      ...
      <nav aria-label="Folder breadcrumb" className="flex items-center gap-1.5 min-w-0 overflow-hidden pb-4">
        <span className="flex items-center gap-1.5 shrink-0">
          <Button
            ...
            className="h-auto p-0 font-sans text-sm text-muted-foreground no-underline hover:text-interactive-hover-foreground tracking-normal"
          >
            Library
          </Button>
          {trail.length > 0 && (
      ...
      >
          ...
          <Tip
            ...
            label={(
              <span className="flex max-w-[14rem] flex-col gap-1.5 text-start">
                ...
                <span className="text-xs leading-snug text-background/85">
                  Opens a floating panel to name the folder, pick tint and icon, then create it here.
                </span>
              </span>
            )}
          >
            <Button
              ...
              variant="ghost"
              className={cn(
                "h-auto w-full flex-col items-center gap-2 rounded-xl border border-dashed border-muted-foreground/45 bg-muted/10 p-3 text-center font-normal transition-[background-color,border-color,box-shadow] duration-150 ease-out",
              ...
              {isRenaming ? (
                ...
                >
                  <Button
                    ...
                    variant="ghost"
                    className={cn(
                      "h-auto w-full flex-col items-center gap-2 rounded-xl border border-transparent p-3 text-center font-normal transition-[background-color,border-color,box-shadow] duration-150 ease-out",
        ...
        {filesHere.map(q => (
          <div key={q.id} role="listitem" className="group relative">
            <Card size="sm" className="w-full items-center gap-3 rounded-2xl text-center shadow-sm">
                ...
                <div className="flex flex-wrap gap-2">
                  {COLOR_OPTIONS.map(c => (
                    <Button
                      ...
                      className={cn(
                        "size-9 rounded-lg border-2 p-0 transition-[opacity,box-shadow,border-color] duration-150 ease-out",
