...
**Layout:** Non-table view branches wrap in **`ListPageViewFrame`** (constants in **`list-page-view-frame.tsx`**) — see **`.agents/rules/exxat-list-page-view-shells.md`**.
...
**Rule:** **`.agents/rules/exxat-centralized-list-dataset.md`** (presentation bullets §8–10).

---

## See also

- `.agents/rules/exxat-centralized-list-dataset.md`
- `.agents/rules/exxat-list-page-connected-views.md`
- `.agents/rules/exxat-list-page-view-shells.md`
- `.agents/rules/exxat-table-properties-drawer.md`
- `.agents/rules/exxat-data-tables.md`
