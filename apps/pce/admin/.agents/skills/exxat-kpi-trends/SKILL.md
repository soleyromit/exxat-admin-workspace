...
- **`docs/exxat-ds/kpi-trend-pattern.md`** — product table + psychometrics example (PBI).
- **`.agents/rules/exxat-kpi-trends.md`** — binding MUST/MUST NOT.
- **`components/key-metrics.tsx`** — `MetricTrendPolarity`, `metricTrendTone`, `metricTrendAriaQualifier`, `MetricCell` rendering.
