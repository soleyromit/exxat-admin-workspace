...
5. **Sidebar / shell tasks:** change **`lib/mock/navigation.tsx`** (or
   ...
   styling to mimic a legacy screenshot (`exxat-sidebar-shell.md`).
...
`.agents/rules/exxat-ux-discovery-protocol.md`.
...
4. Read `docs/exxat-ds/modern-saas-patterns.md` for the canon you're working
...
- Apply principles from `exxat-ux-principles.md`.
...
- `.agents/rules/exxat-ux-discovery-protocol.md` — brief-before-code gate
- `.agents/rules/exxat-ux-principles.md` — principles + when to break
- `docs/exxat-ds/modern-saas-patterns.md` — what "modern" means here
- `docs/exxat-ds/jobs/` — canonical references per job type
- `.agents/skills/exxat-token-economy/SKILL.md` — minimum files + scaffolds
