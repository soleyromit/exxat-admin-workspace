...
- **`.agents/rules/exxat-card-vs-list-rows.md`**, **`exxat-data-tables.md`**, **`exxat-board-cards.md`**
- **`exxat-centralized-list-dataset.md`** — one `tableState.rows` for table + board + cards
