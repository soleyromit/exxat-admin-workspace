...
- Release notes via `npx --package=@exxatdesignux/ui@latest exxat-ui changelog` (reads GitHub `RELEASES.md` when not bundled — since 0.5.22)
...
Touches **only** `.agents/skills/exxat-*`, `.agents/rules/exxat-*.mdc`,
...
Rule: **`.agents/rules/exxat-package-publish-validation.md`**
