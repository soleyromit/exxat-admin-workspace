...
<!-- Synced from .agents/rules/exxat-ux-principles.mdc - run npx exxat-ui sync-extras after Cursor rule edits -->
...
(`exxat-ux-discovery-protocol.md`). If you can't write the deviation reason
...
- **Reference:** `exxat-breadcrumbs-no-back.md`.
...
- **Placement:** Action pairs (dialog footer, exam pause panel, wizard footer) — secondary `outline` **left**, filled primary **right** (`dialog-pattern.md`).
- **Why:** Two primaries = no primary; wrong placement hides the main action.
...
- **When to break:** Never.
- **Reference:** `exxat-no-image-pixel-copy.md`.
...
- **Reference:** `exxat-reuse-before-custom.md`.
...
- **Reference:** `exxat-command-menu.md`.
...
- **Reference:** `exxat-command-menu.md` (⌘K vs ⌘⌥K split).
...
- `.agents/skills/exxat-senior-ux/SKILL.md` — the persona
- `.agents/rules/exxat-ux-discovery-protocol.md` — gating + brief
