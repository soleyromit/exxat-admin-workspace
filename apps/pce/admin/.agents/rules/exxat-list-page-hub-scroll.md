...
**`folder` · `panel` · `tree-panel` · `dashboard`** — Use **`viewportToolbarShell`** so the body fills the tab and owns Miller/tree/canvas scroll regions. See **`exxat-list-page-view-shells.md`**.
