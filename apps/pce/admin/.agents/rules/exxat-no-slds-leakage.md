...
<!-- Synced from .agents/rules/exxat-no-slds-leakage.mdc - run npx exxat-ui sync-extras after Cursor rule edits -->
...
- [`.agents/rules/exxat-token-discipline.md`](mdc:.agents/rules/exxat-token-discipline.md) — token-level enforcement
- [`.agents/rules/exxat-reuse-before-custom.md`](mdc:.agents/rules/exxat-reuse-before-custom.md) — ask before adding new primitives
