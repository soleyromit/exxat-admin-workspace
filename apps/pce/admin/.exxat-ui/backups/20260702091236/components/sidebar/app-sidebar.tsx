...
function NavItemBadgeContent({ badge }: { badge: number | string }) {
  ...
  if (badge === "New") return <StatusBadge status="new" className="normal-case tracking-normal" />
  if (badge === "Beta") return <StatusBadge status="beta" className="normal-case tracking-normal" />
  return (
...
function NavPrimarySectionGroup({
  ...
  return (
    ...
    >
      {section.label.trim() ? (
        <SidebarGroupLabel
          className="text-xs font-medium px-2 text-sidebar-section-label"
          suppressHydrationWarning
        >
          {section.label}
        </SidebarGroupLabel>
