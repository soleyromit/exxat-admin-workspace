          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              >
                PBI score
                <i
                  className="fa-light fa-circle-info text-[13px] text-muted-foreground"
                  aria-hidden="true"
                />
              </span>
            </Tip>
    ...
    <div className="space-y-2">
      <BuilderListRow highlighted={option.isCorrect}>
        ...
        >
          ...
          >
            {option.isCorrect ? (
              <i className="fa-solid fa-check text-[13px] leading-none" aria-hidden="true" />
            ) : (
              letter
            )}
          </button>
    ...
    <div className="space-y-2">
      <BuilderListRow>
        ...
        <Tip side="top" label={kindMeta.description}>
          ...
          >
            <i className={cn("fa-light text-[13px]", kindMeta.icon)} aria-hidden="true" />
          </span>
        </Tip>
