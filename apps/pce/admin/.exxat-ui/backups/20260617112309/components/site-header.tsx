 ...
 *  ✓ Plain <div> wrapper — NOT a <header>/banner landmark. This bar renders
 *    inside <SidebarInset> (a <main> landmark), and a banner must be a
 *    top-level landmark (direct child of <body>), never nested in <main>.
 *    Nesting it triggered axe `landmark-banner-is-top-level`. Breadcrumb
 *    navigation semantics come from the DS Breadcrumb's own <nav> landmark.
