...
export const NAV_ADMIN: NavLinkItem[] = [
  {
    ...
    children: [
      ...
      },
      {
        key: "ce-activate",
        title: "Activate Term",
        url: "/surveys/activate",
        icon:       <i className="fa-light fa-circle-play" aria-hidden="true" />,
        iconActive: <i className="fa-solid fa-circle-play" aria-hidden="true" />,
      },
      {
        key: "ce-analytics",
        title: "Analytics",
  ...
  },
  {
    ...
    children: [
      { key: "setup-overview",    title: "Overview",          url: "/admin/setup",              icon: <i className="fa-light fa-house-chimney-window" aria-hidden="true" />, iconActive: <i className="fa-solid fa-house-chimney-window" aria-hidden="true" /> },
