...
export const MOCK_OPEN_TEXT_RESPONSES: PceOpenTextResponse[] = [
  ...
  { id: 'otr-uon-f4-4', surveyId: 'uon-f4', questionText: 'What would you like to tell future students about this instructor?', text: "Would not have made it through pharmacology without Dr. Gomez's guest session on antibiotics.", sectionSubject: 'faculty', sentiment: 'positive' },
