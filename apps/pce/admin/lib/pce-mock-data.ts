...
export interface PceSurvey {
  ...
  cohort?: string
  /** Per UC-14 + workspace ADR-002: experiential | classroom | lab (optional, extensible). Updated per PRD §2 Key Decision #5 (14 Jun 2026) — replaces Didactic/Clinical taxonomy. "Practice" renamed to "Experiential" per 2026-07-28 stakeholder feedback (Vishaka + David). */
