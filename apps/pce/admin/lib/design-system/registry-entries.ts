...
export const DESIGN_SYSTEM_REGISTRY_ENTRIES: DesignSystemRegistryEntry[] = [
  ...
  c({ slug: "scroll-region", name: "Scroll Region", group: "Layout", description: "Product scroll wrapper with DS overflow chrome.", importPath: `${UI}/scroll-region`, sourcePath: "packages/ui/src/components/ui/scroll-region.tsx", parentSlug: "scroll-area" }),
  ...
  c({ slug: "message", name: "Message", group: "Leo", description: "Chat turn layout — avatar + content row; align start (assistant) or end (user). Compose with Bubble and MessageScroller.", importPath: `${UI}/message`, sourcePath: "packages/ui/src/components/ui/message.tsx", catalogId: "ui-message", status: "live" }),
  c({ slug: "bubble", name: "Bubble", group: "Leo", description: "Chat bubble chrome — default (user primary) or ghost (assistant).", importPath: `${UI}/bubble`, sourcePath: "packages/ui/src/components/ui/bubble.tsx", catalogId: "ui-bubble", parentSlug: "message", status: "live" }),
  c({ slug: "marker", name: "Marker", group: "Leo", description: "Inline status row for thinking/streaming — icon + shimmer label.", importPath: `${UI}/marker`, sourcePath: "packages/ui/src/components/ui/marker.tsx", catalogId: "ui-marker", parentSlug: "message", status: "live" }),
  c({ slug: "message-scroller", name: "MessageScroller", group: "Leo", description: "Auto-scroll transcript viewport for Ask Leo threads.", importPath: `${UI}/message-scroller`, sourcePath: "packages/ui/src/components/ui/message-scroller.tsx", catalogId: "ui-message-scroller", parentSlug: "message", status: "live" }),
  c({ slug: "ai-thinking-surface", name: "AI Thinking Surface", group: "Leo", description: "Leo thinking / streaming surface chrome.", importPath: "@/components/ui/ai-thinking-surface", sourcePath: "apps/web/components/ui/ai-thinking-surface.tsx", parentSlug: "message" }),
  c({ slug: "leo-icon", name: "Leo Icon", group: "Leo", description: "Brand Leo mark for buttons and chips.", importPath: "@/components/ui/leo-icon", sourcePath: "apps/web/components/ui/leo-icon.tsx", parentSlug: "message" }),
  ...
  p({ slug: "secondary-hub-nav-primitives", name: "Secondary hub nav primitives", group: "Navigation", description: "Shared compact rail + nav rows for Library, Learning activities, and other SecondaryPanel hubs.", importPath: "@/components/sidebar/secondary-hub-nav-primitives", sourcePath: "apps/web/components/sidebar/secondary-hub-nav-primitives.tsx", status: "live" }),
  ...
  p({ slug: "key-metrics", name: "KeyMetrics", group: "Page chrome", description: "KPI strip — flat band, card strip, or per-metric cards — with trends and insight rail.", importPath: "@/components/key-metrics", sourcePath: "apps/web/components/key-metrics.tsx", catalogId: "comp-key-metrics", status: "live" }),
  ...
  p({ slug: "utility-bar", name: "UtilityBarSlot", group: "Page chrome", description: "Shell row for Search, Ask Leo, Notifications, Help, Settings, and profile — hidden in sidebar-classic; workspace-scoped or full-width via ShellLayoutContext.", importPath: "@/components/utility-bar-slot", sourcePath: "apps/web/components/utility-bar-slot.tsx", status: "live" }),
  ...
  ex({ slug: "learning-activities-hub", name: "Learning activities", group: "Reference hubs", description: "Secondary-panel hub — courses, reports, notifications, activity groups.", importPath: "@/components/learning-activities-client", catalogId: "hub-learning-activities", routeSuffix: "/clinical-education/learning-activities", status: "catalog" }),
  ex({ slug: "learning-activities-course-detail", name: "Course offering detail", group: "Reference hubs", description: "Record detail — setup, forms, patient log, timesheet, gradebook, reports per offering.", importPath: "@/components/learning-activities-course-detail-client", catalogId: "hub-learning-activities-course", routeSuffix: "/clinical-education/learning-activities/courses/co-1", status: "catalog" }),
  ...
  rule({ slug: "rule-primary-nav-secondary-panel", name: "Primary nav → secondary panel", group: "Navigation", description: "Hub scope rail IA, compact rail parity, PANELS registry.", importPath: ".cursor/rules/exxat-primary-nav-secondary-panel.mdc", sourcePath: ".cursor/rules/exxat-primary-nav-secondary-panel.mdc" }),
  rule({ slug: "rule-hub-supported-views", name: "Hub supported views", group: "Data views", description: "Table, board, dashboard, folder, panel, tree view tabs.", importPath: ".cursor/rules/exxat-hub-supported-views.mdc", sourcePath: ".cursor/rules/exxat-hub-supported-views.mdc" }),
  rule({ slug: "rule-centralized-list-dataset", name: "Centralized list dataset", group: "Data views", description: "One useTableState bag per hub.", importPath: ".cursor/rules/exxat-centralized-list-dataset.mdc", sourcePath: ".cursor/rules/exxat-centralized-list-dataset.mdc" }),
  rule({ slug: "rule-board-cards", name: "Board cards", group: "Data views", description: "ListPageBoardCard kanban shell.", importPath: ".cursor/rules/exxat-board-cards.mdc", sourcePath: ".cursor/rules/exxat-board-cards.mdc" }),
  rule({ slug: "rule-focus-workflow", name: "Focus workflow", group: "Focus", description: "Exam lock and compose shells strip chrome.", importPath: ".cursor/rules/exxat-focus-workflow.mdc", sourcePath: ".cursor/rules/exxat-focus-workflow.mdc" }),
  rule({ slug: "rule-command-menu", name: "Command menu", group: "Shell", description: "⌘K global search vs Ask Leo escalation.", importPath: ".cursor/rules/exxat-command-menu.mdc", sourcePath: ".cursor/rules/exxat-command-menu.mdc" }),
  rule({ slug: "rule-utility-bar", name: "Utility bar", group: "Shell", description: "Shell utility row variants and spacing.", importPath: ".cursor/rules/exxat-utility-bar.mdc", sourcePath: ".cursor/rules/exxat-utility-bar.mdc" }),
  rule({ slug: "rule-ask-leo", name: "Ask Leo", group: "Leo", description: "Thread primitives and sidebar.", importPath: ".cursor/rules/exxat-ask-leo.mdc", sourcePath: ".cursor/rules/exxat-ask-leo.mdc" }),
  rule({ slug: "rule-no-toast", name: "No toast", group: "Feedback", description: "Banners and inline status — not snackbars.", importPath: ".cursor/rules/exxat-no-toast.mdc", sourcePath: ".cursor/rules/exxat-no-toast.mdc" }),
  rule({ slug: "rule-reuse-before-custom", name: "Reuse before custom", group: "Foundation", description: "Compose DS primitives before new shared components.", importPath: ".cursor/rules/exxat-reuse-before-custom.mdc", sourcePath: ".cursor/rules/exxat-reuse-before-custom.mdc" }),
  ...
  skill({ slug: "skill-primary-nav-secondary-panel", name: "exxat-primary-nav-secondary-panel", group: "Navigation", description: "Secondary panel wiring + hub nav parity checklist.", importPath: ".cursor/skills/exxat-primary-nav-secondary-panel/SKILL.md", sourcePath: ".cursor/skills/exxat-primary-nav-secondary-panel/SKILL.md" }),
  skill({ slug: "skill-centralized-list-dataset", name: "exxat-centralized-list-dataset", group: "Data views", description: "Single useTableState dataset per hub.", importPath: ".cursor/skills/exxat-centralized-list-dataset/SKILL.md", sourcePath: ".cursor/skills/exxat-centralized-list-dataset/SKILL.md" }),
  skill({ slug: "skill-board-cards", name: "exxat-board-cards", group: "Data views", description: "Kanban board card composition.", importPath: ".cursor/skills/exxat-board-cards/SKILL.md", sourcePath: ".cursor/skills/exxat-board-cards/SKILL.md" }),
  skill({ slug: "skill-kpi", name: "exxat-kpi", group: "Page chrome", description: "KPI strips — flat band, trends, max four.", importPath: ".cursor/skills/exxat-kpi/SKILL.md", sourcePath: ".cursor/skills/exxat-kpi/SKILL.md" }),
  skill({ slug: "skill-overlays", name: "exxat-overlays", group: "Overlays", description: "Sheet vs dialog vs route.", importPath: ".cursor/skills/exxat-overlays/SKILL.md", sourcePath: ".cursor/skills/exxat-overlays/SKILL.md" }),
  skill({ slug: "skill-sidebar-nav", name: "exxat-sidebar-nav", group: "Navigation", description: "Sidebar, drill-in, secondary panel.", importPath: ".cursor/skills/exxat-sidebar-nav/SKILL.md", sourcePath: ".cursor/skills/exxat-sidebar-nav/SKILL.md" }),
  skill({ slug: "skill-surface-router", name: "exxat-surface-router", group: "Agents", description: "Task → minimum file set router.", importPath: ".cursor/skills/exxat-surface-router/SKILL.md", sourcePath: ".cursor/skills/exxat-surface-router/SKILL.md" }),
  skill({ slug: "skill-chart-leo-spotting", name: "exxat-chart-leo-spotting", group: "Leo", description: "Plot insight pill + connector on charts.", importPath: ".cursor/skills/exxat-chart-leo-spotting/SKILL.md", sourcePath: ".cursor/skills/exxat-chart-leo-spotting/SKILL.md" }),
  skill({ slug: "skill-react-doctor", name: "react-doctor", group: "Ship gate", description: "Pre-commit React hygiene scan.", importPath: ".cursor/skills/react-doctor/SKILL.md", sourcePath: ".cursor/skills/react-doctor/SKILL.md" }),
