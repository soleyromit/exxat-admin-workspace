...
**Parent skill:** `.cursor/skills/exxat-accessibility/SKILL.md`  
...
3. Load **`.cursor/skills/exxat-accessibility/SKILL.md`** for Exxat-specific fix patterns (icon rail, resize handles, contrast tokens).
...
- `.cursor/skills/exxat-accessibility/SKILL.md` — WCAG checklist + Exxat patterns
- `apps/web/docs/accessibility-ship-checklist.md` — manual ship gate (axe + reflow)
