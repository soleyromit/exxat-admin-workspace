...
export function isLibrarySecondaryPanelVisible(
  ...
  return isLibraryFocusedFlowPath(pathname) && activePanel === "library"
}

/**
 * Focus template under `/library/*` that keeps the library scope rail instead of
 * the primary sidebar — e.g. New question when the user arrived from Library.
 */
