      ...
      >
        ...
        {effectiveSearchable && (
          searchOpen ? (
            ...
            /* TooltipProvider lives at app root (layout.tsx) — inner Provider
               is vestigial. Per actions-overlays.md depth audit. */
            <Tooltip>
...
export interface DataTableExtendedProps<TData extends Record<string, unknown>>
  ...
  state?: ReturnType<typeof useTableState<TData>>
  /** Initial group-by column key. The user can clear it via the column menu. */
  defaultGroupBy?: string | null
  /** Map of group-key → display label for sticky group dividers. */
