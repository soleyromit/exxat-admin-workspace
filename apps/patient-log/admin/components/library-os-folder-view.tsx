 ...
 * create (floating panel + preview), inline rename, move / delete, and move questions between folders.
 */
      ...
      <nav aria-label="Folder breadcrumb" className="flex items-center gap-1.5 min-w-0 overflow-hidden pb-4">
        <span className="flex items-center gap-1.5 shrink-0">
          <Button
            ...
            className="h-auto w-auto -m-1 p-1 font-sans text-sm font-normal tracking-normal text-muted-foreground"
          >
            Library
          </Button>
          {trail.length > 0 && (
      ...
      >
        ...
        <div role="listitem" className="relative">
          ...
          >
            <Button
              ...
              variant="ghost"
              className={cn(
                "h-auto w-full flex-col items-center gap-2 rounded-xl border border-dashed border-muted-foreground/45 bg-muted/10 p-3 text-center",
                "hover:border-muted-foreground/70 hover:bg-muted/20 hover:text-muted-foreground",
              )}
              ...
              {isRenaming ? (
                ...
                >
                  <Button
                    ...
                    variant="ghost"
                    className={cn(
                      "h-auto w-full flex-col items-center gap-2 rounded-xl border border-transparent p-3 text-center",
                      "hover:border-border/80 hover:bg-muted/35 hover:text-foreground",
                    )}
        ...
        {filesHere.map(q => (
          <div key={q.id} role="listitem" className="group relative">
            <Card size="sm">
              <CardContent className="flex w-full flex-col items-center gap-3 text-center">
                ...
                <div className="flex flex-wrap gap-2">
                  {COLOR_OPTIONS.map(c => (
                    <Button
                      ...
                      className={cn(
                        "size-9 rounded-lg border-2 p-0",
