...
import { directoryLaunchSummaries, productHomeSlug } from "@/lib/product-home"
import {
...
/**
 * People Management and Course Management.
 *
 ...
 * story. Personnel Management is site-scoped and is not a Directory row.
 */
/**
...
function DirectoryRows() {
  const records = React.useMemo(() => directoryLaunchSummaries(), [])
  // Everyone but a student, on the same predicate as the `/people` and `/courses`
  // routes these link to. A wider gate than the Administrator
...
export function ProductSwitcherMenuItems() {
  ...
  return (
    <>
      ...
      {/* Administrator closes "Your App" rather than sitting with Home as a
          utility row. It is an app this person opens, not a link away:
