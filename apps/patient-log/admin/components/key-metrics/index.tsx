 ...
 *     imports from `@/components/ask-leo-sidebar`.
 *
 * Variants:
...
/* ── Ask Leo stubs ─────────────────────────────────────────────────────────
 * Patient Log has no Ask Leo provider yet. These are no-op shims so KeyMetrics
 * renders cleanly. Swap for real imports from `@/components/ask-leo-sidebar`
 * once Patient Log adopts the provider.
 */
function useAskLeo() {
  return { toggle: () => {} }
}

function AskLeoShortcutKbds() {
  return null
}
