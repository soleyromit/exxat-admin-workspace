...
const LEGACY_KEYS: Partial<Record<DataViewScope, string>> = {
  placements: "exxat-dashboard-cards",
  team: "exxat-team-dashboard-cards",
  compliance: "exxat-compliance-dashboard-cards",
}

export type DataViewScope = "placements" | "team" | "compliance" | "library"
...
function ensureBundleWithLegacy(): LayoutBundle {
  ...
  let changed = false
  for (const scope of ["placements", "team", "compliance", "library"] as const) {
