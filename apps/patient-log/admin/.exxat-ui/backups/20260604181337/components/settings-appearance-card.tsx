...
export function SettingsAppearanceCard({
  ...
  const productOptions = React.useMemo((): ProductListOption[] => {
    const builtIns: ProductListOption[] = [
      ...
      { value: "exxat-one-schools", label: "Exxat One — Schools", scope: "Schools" },
      { value: "exxat-one-sites", label: "Exxat One — Sites", scope: "Sites" },
    ]
                ...
                {productOptions.map(option => {
                  ...
                  return (
                    ...
                    >
                      ...
                      ) : productAuthoringEnabled && !isActive ? (
