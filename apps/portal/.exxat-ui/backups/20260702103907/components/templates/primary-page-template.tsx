  ...
  return (
    <SidebarInset
      ...
      className={cn(
        pageCanvas && "relative",
        containScroll &&
          "flex min-h-0 max-h-[calc(100svh-0.75rem)] flex-1 flex-col overflow-hidden px-2 pb-4 [--composer-card-shadow-inset:0.75rem]",
      )}
    >
      {pageCanvas}
      {beforeSiteHeader}
      ...
      <div
        className={cn(
          ...
          containScroll && "relative z-[1] min-h-0 flex-1 overflow-hidden py-1",
          bodyClassName,
        )}
      >
        <div
