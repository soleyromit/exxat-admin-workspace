# CLAUDE — Admin & Student DS Reference

> **Lazy-loaded reference.** This file is NOT loaded by default. Read it before generating UI code, importing DS components, using DS tokens, or scaffolding a new product UI.
>
> **When the UserPromptSubmit hook flags `lazy:ds-reference`** — that's the signal to Read this file. Tokens, component APIs, theme system, and font setup live here.
>
> Companion to `CLAUDE.md` which keeps the high-frequency sections (paths, imports, absolute rules, dev commands).
>
> Last regenerated from source: 2026-04-16.
