# Workspace Digest — 2026-05-12

> Auto-generated by `scripts/generate-digest.py` on 2026-05-12. One-line summary of every load-bearing artifact across the workspace. Loaded by the SessionStart hook on compact-recovery so the assistant has a current snapshot without re-reading every file.
