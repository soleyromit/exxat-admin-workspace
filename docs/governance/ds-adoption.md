...
|---|---|---|---|
| `apps/pce/admin/components/pce/trend-sparkline.tsx` | ~40 | Chart (could be ChartContainer + Line) | Aarti 2026-05-09 "viz first": sparkline must be inline, no axes/labels — DS Chart wrapper adds chrome. Hand-roll is intentional. |
