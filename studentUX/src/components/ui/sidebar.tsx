...
function SidebarProvider({
  ...
  const [sidebarWidth, setSidebarWidth] = React.useState<string>(SIDEBAR_WIDTH);
  const sidebarWidthRef = React.useRef<string>(SIDEBAR_WIDTH);
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <FontAwesomeIcon name="sidebar" weight="regular" />
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:rounded-2xl md:peer-data-[variant=inset]:shadow-sm",
        className,
      )}
      {...props}
    />
