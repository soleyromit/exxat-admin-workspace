import svgPaths from "./svg-yzqvgivh24";
...
function FormContainer() {
  return (
    <div className="absolute h-[470px] left-[calc(16.67%+42.67px)] overflow-clip top-[160px] w-[768px]" data-name="Form container">
      <Frame6 />
    </div>
  );
}
...
function Container2() {
  return <div className="bg-gradient-to-r from-[#fc52a1] from-[68.688%] h-[8px] rounded-[100px] shrink-0 to-[#f3d45b] to-[128.59%] w-[394px]" data-name="Container" />;
}
...
function Button1() {
  return (
    <div className="bg-[#39393c] content-stretch flex gap-[8px] h-[40px] items-center justify-center min-w-[96px] opacity-40 px-[12px] py-0 relative rounded-[4px] shrink-0 w-[272px]" data-name="Button">
...
export default function Step21Of() {
  return (
    <div className="relative size-full" data-name="Step 2.1 of 4" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\\'0 0 1280 812\\\' xmlns=\\\'http://www.w3.org/2000/svg\\\' preserveAspectRatio=\\\'none\\\'><rect x=\\\'0\\\' y=\\\'0\\\' height=\\\'100%\\\' width=\\\'100%\\\' fill=\\\'url(%23grad)\\\' opacity=\\\'1\\\'/><defs><radialGradient id=\\\'grad\\\' gradientUnits=\\\'userSpaceOnUse\\\' cx=\\\'0\\\' cy=\\\'0\\\' r=\\\'10\\\' gradientTransform=\\\'matrix(129.45 97.4 -80.275 106.69 367 220)\\\'><stop stop-color=\\\'rgba(255,255,255,1)\\\' offset=\\\'0.052885\\\'/><stop stop-color=\\\'rgba(253,249,241,1)\\\' offset=\\\'1\\\'/></radialGradient></defs></svg>')" }}>
      ...
      <FormContainer />
      <Container4 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[1.2] left-[calc(16.67%+42.67px)] not-italic text-[#101828] text-[20px] top-[112px] tracking-[-0.2px] w-[768px]">{`✨ Great! Now let's make your profile stand out`}</p>
      <Frame7 />
    </div>
  );
}