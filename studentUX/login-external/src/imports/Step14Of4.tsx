import svgPaths from "./svg-e0sfk0z85b";
...
function Container2() {
  return <div className="bg-gradient-to-r from-[#fc52a1] from-[68.688%] h-[8px] rounded-[1.67772e+07px] shrink-0 to-[#f3d45b] to-[128.59%] w-[254px]" data-name="Container" />;
}
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre">Tell me the type of role are you seeking</p>
    </div>
  );
}
...
function Stethoscope() {
  return (
    <div className="absolute left-1/2 size-[36px] top-[calc(50%-0.75px)] translate-x-[-50%] translate-y-[-50%]" data-name="stethoscope">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="stethoscope">
          <path d={svgPaths.p2e0bc500} fill="var(--fill-0, black)" id="Primary" />
        </g>
      </svg>
    </div>
  );
...
function Frame4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre">Select 5 skills for better recommendations!</p>
    </div>
  );
}
...
function AddLine() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="add-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="add-line">
          <path d={svgPaths.p15007300} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#dedede] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Manual Therapy</p>
      <AddLine />
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#dedede] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Patient care</p>
      <AddLine1 />
    </div>
  );
}
...
function CheckLine() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="check-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="check-line">
          <path d={svgPaths.p3f8e2200} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame13() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center p-[12px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Manual Therapy Techniques</p>
      <CheckLine />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center p-[12px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Empathy</p>
      <CheckLine1 />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Therapeutic Exercise</p>
      <CheckLine2 />
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center p-[12px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Analytical skills</p>
      <CheckLine3 />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Gait Analysis</p>
      <CheckLine4 />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="bg-[#dae4fb] content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#aaebff] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Patient Assessment</p>
      <CheckLine5 />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#dedede] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Communication</p>
      <AddLine2 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex gap-[8px] h-[24px] items-center justify-center px-[12px] py-[8px] relative rounded-[24px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#dedede] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[12px] text-black text-nowrap whitespace-pre">Time management</p>
      <AddLine3 />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-center flex flex-wrap gap-[12px] items-center relative shrink-0 w-[360px]">
      <Frame9 />
      <Frame16 />
      <Frame13 />
      <Frame17 />
...
function Frame41() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-center left-1/2 top-[calc(50%-154px)] translate-x-[-50%] translate-y-[-50%] w-[480px]">
      <Frame29 />
      <Frame5 />
...
function FormContainer() {
  return (
    <div className="absolute bg-neutral-100 h-[536px] left-[calc(25%+80px)] overflow-clip top-[160px] w-[480px]" data-name="Form container">
      <div className="absolute h-0 left-1/2 top-[312px] translate-x-[-50%] w-[480px]" data-name="Background highlighter">
