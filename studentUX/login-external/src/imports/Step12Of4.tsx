import svgPaths from "./svg-lc3lq1a4fp";
...
function Container2() {
  return <div className="bg-gradient-to-r from-[#fc52a1] from-[68.688%] h-[8px] rounded-[1.67772e+07px] shrink-0 to-[#f3d45b] to-[128.59%] w-[104px]" data-name="Container" />;
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-center left-1/2 top-0 translate-x-[-50%] w-[480px]">
      <Frame14 />
...
function FormContainer() {
  return (
    <div className="absolute bg-neutral-100 h-[360px] left-[calc(25%+80px)] overflow-clip top-[160px] w-[480px]" data-name="Form container">
      <div className="absolute h-0 left-1/2 top-[247px] translate-x-[-50%] w-[480px]" data-name="Background highlighter">
...
function Button() {
  return (
    <div className="absolute bg-[#39393c] content-stretch flex gap-[8px] h-[40px] items-center justify-center left-[calc(33.33%+77.33px)] min-w-[96px] px-[12px] py-0 rounded-[4px] top-[544px] w-[272px]" data-name="Button">
