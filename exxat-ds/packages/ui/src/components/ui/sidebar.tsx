  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          // min-h-0 (not min-h-svh): avoid forcing the shell to viewport height when content is
          // short — prevents a flex-1 content row from growing with empty space + inset scroll.
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "relative flex min-h-0 w-full flex-1 flex-col bg-background pb-8 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2",
        className
      )}
      {...props}
    />
